...
class RolloutDataset(TrajDataset):
    def __init__(
        self,
        data_path: str = "data/rollout",
    ...
    def get_frames(self, idx, frames):
        ...
        image = torch.load(obs_dir / f"episode_{idx:03d}.pth")[1:]
...
def load_rollour_slice_train_val(
    transform,
    n_rollout=50,
    data_path='data/rollout_dset',
